;; -*- lisp-version: "9.0 [Windows] (May 4, 2015 16:02)"; cg: "9.0"; -*-

(in-package :cg-user)

(define-project :name :project2
  :modules (list (make-instance 'module :name "job-shop-problemas-modelos.lisp")
                 (make-instance 'module :name "job-shop-problemas-v1.lisp")
                 (make-instance 'module :name "procura.lisp"))
  :projects nil
  :libraries nil
  :editable-files nil
